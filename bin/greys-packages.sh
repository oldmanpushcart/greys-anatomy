...
# greys's version
GREYS_VERSION=$(cat ${BASEDIR}/..//greys-core/src/main/resources/com/github/ompc/greys/core/res/version)
...
cp ${BASEDIR}/../greys-core/target/greys-core-jar-with-dependencies.jar ${GREYS_TARGET_DIR}/greys-core.jar
