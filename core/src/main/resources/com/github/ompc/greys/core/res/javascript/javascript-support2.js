...
//    paths: {
//        'test': '/tmp/t.js',
//        'json': 'http://ompc.oss-cn-hangzhou.aliyuncs.com/greys/javascript/json2.js'
//    }
//});
////
//require(['test', 'test'], function (test1, test2) {
//    java.lang.System.out.println("" + test1.addx(1, 2, 3));
//    java.lang.System.out.println("" + test2.addx(3, 2, 3));
//    java.lang.System.out.println("test1.inc" + test1.inc(1));
//    java.lang.System.out.println("test1.inc" + test1.inc(2));
//    java.lang.System.out.println("test2.inc" + test2.inc(2));
//});
//
//require(['test'], function (test) {
//    java.lang.System.out.println("" + test.addx(1, 2, 3));
//});
//
//require(['test'], function () {
//    java.lang.System.out.println("" + require('test').inc(1));
//    java.lang.System.out.println("" + require('test').inc(2));
//});
//
//
//define('stock', ['test'], function (test) {
//    return {
//        take: function () {
//            return test.inc(12);
//        }
...
//    java.lang.System.out.println(stock.take());
//})
//
//
//define('dukun', function () {
//    return {
//        name: 'dukun',
...
//})
//
//require(['dukun'], function (dukun) {
//    java.lang.System.out.println("name=" + dukun.name + ";email=" + dukun.email);
//})
//
//
//load('http://ompc.oss-cn-hangzhou.aliyuncs.com/greys/javascript/json2.js');
//java.lang.System.out.println("" + JSON.stringify({name: 'dukun', email: 'oldmanpushcart@gmail.com'}));

//var x = new Function("return "+'define(function(){function subx(a,b,c){return a-b-c;};return {subx:subx}})').call(this);
